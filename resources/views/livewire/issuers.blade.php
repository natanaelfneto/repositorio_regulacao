	...
	<div class="row push  mx-auto">
		<div class="container block-rounded bg-white">
			<div class="block-header block-header-default text-left">
				<h3 class="block-title">Cadastrar Órgão Emissor</h3>
			</div>
				...
				<form action="{{ route('professions') }}" method="POST">
					<div class="row push">
						...
						<div class="col-lg-8 col-xl-5">
							...
							<div class="mb-4">
								<label class="form-label" for="example-email-input">URL da página oficial</label>
								<input type="text" class="form-control" id="cbo" name="cbo" placeholder="https://...">
							</div>
							<div class="mb-4">
								<label class="form-label" for="example-password-input">Símbolo da entidade emissora</label>
	...
	<div class="row push">
		<div class="container block block-rounded">
			<div class="block-header block-header-default">
				<h3 class="block-title">Órgãos Emissores</h3>
			</div>
				...
				<table class="grid-sm-table table table-striped table-vcenter font-size-sm mb-0">
					<thead>
						<tr>
							...
							<th class="text-left">Órgão Emissor</th>
						...
						@if ($object_list->count())
							@foreach ($object_list as $object)
								...
								<tr>
									...
									<td class="d-none d-md-table-cell fs-sm">{{ $object->issuer_name }}</td>
									<td class="text-center">
										<div class="btn-group">
