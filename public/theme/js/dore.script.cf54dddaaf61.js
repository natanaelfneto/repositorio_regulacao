...
$.dore = function (element, options) {
  ...
  function init() {
    ...
    if (typeof Chart !== "undefined") {
      ...
      if (document.getElementById("MedicalExample")) {
        var MedicalExample = document.getElementById("MedicalExample").getContext("2d");
        var myChart = new Chart(MedicalExample, {
            ...
            data: {
                ...
                labels: ["Mamografia", "Raio-X", "Densitometria Óssea"]
            }
            }
        );
    }
