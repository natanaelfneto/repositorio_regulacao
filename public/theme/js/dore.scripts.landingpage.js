$.dore = function(e, o) {
    ...
    ! function() {
        ...
        }).data("owl.carousel").onResize(), $(".client-carousel").length > 0 && $(".client-carousel").owlCarousel({
            margin: 30,
            stagePadding: 15,
            autoplay: !0,
            loop: !0,
            dotsContainer: $(".client-carousel").parents(".owl-container").find(".slider-dot-container"),
            responsive: {
                0: {
                    items: 1
                },
        ...
        }).data("owl.carousel").onResize(), $(".review-carousel").length > 0 && $(".review-carousel").owlCarousel({
            margin: 30,
            stagePadding: 15,
            autoplay: !0,
            loop: !0,
            dotsContainer: $(".review-carousel").parents(".owl-container").find(".slider-dot-container"),
            responsive: {
                0: {
                    items: 1
                },
        ...
        }).data("owl.carousel").onResize(), $(".team-carousel").length > 0 && $(".team-carousel").owlCarousel({
            margin: 30,
            stagePadding: 15,
            loop: !0,
            autoplay: !0,
            dotsContainer: $(".team-carousel").parents(".owl-container").find(".slider-dot-container"),
            responsive: {
                0: {
                    items: 2
                },
