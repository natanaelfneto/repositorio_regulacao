                    ...
                    s = {
                        init: function() {
                            jQuery('[data-toggle="block-option"][data-action="fullscreen_toggle"]').each(function(e, a) {
                                ...
                                var t = jQuery(a);
                                t.html('<i class="' + (t.closest(".block").hasClass("block-mode-hidden") ? "fa4 fa4-angle-down" : "fa4 fa4-angle-up") + '"></i>')
                        ...
                        content_toggle: function() {
                            e.toggleClass("block-mode-hidden"), t.length && (e.hasClass("block-mode-hidden") ? jQuery("i", t).removeClass("fa4 fa4-angle-up").addClass("fa4 fa4-angle-down") : jQuery("i", t).removeClass("fa4 fa4-angle-down").addClass("fa4 fa4-angle-up"))
                        },
                        content_hide: function() {
                            e.addClass("block-mode-hidden"), t.length && jQuery("i", t).removeClass("fa4 fa4-angle-up").addClass("fa4 fa4-angle-down")
                        },
                        content_show: function() {
                            e.removeClass("block-mode-hidden"), t.length && jQuery("i", t).removeClass("fa4 fa4-angle-down").addClass("fa4 fa4-angle-up")
                        },
